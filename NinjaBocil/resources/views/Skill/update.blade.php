...
<body>
    <div class="p-4 sm:ml-64 sm:mt-23  min-h-screen dark:bg-gray-800" style="height: 100vh auto;">
        ...
        <form method="POST" action="/skill/updatedata/{{ $skill->id }}" enctype="multipart/form-data"
            class="update_skill">
            @csrf
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input
                        ...
                        onchange="previewImage()" value="{{ Storage::url('public/image/' . $skill->fotoskill) }}">
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">PNG, JPG, JPEG
                        (MAX.
                        800x400px).</p>
                    <br>
                    @if (!$skill->fotoskill)
                        <img src="{{ Storage::url('image/' . $skill->fotoskill) }}" alt="" id="preview"
                            style="width: 200px; height:200px;">
                    @else
                        <img src="{{ Storage::url('image/' . $skill->fotoskill) }}" alt="" id="preview"
                            style="width: 200px; height:200px;">
                        <input type="hidden" name="old_fotoskill" value="{{ $skill->fotoskill }}">
                    @endif
                </div>
            </div>
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    <label for="company" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                        Skill</label>
                    <input type="text" id="nama_skill" name="nama_skill" value="{{ $skill->nama_skill }}"
                ...
                <div>
                    ...
                    <input type="tel" id="slug_skill" name="slug_skill" value="{{ $skill->slug_skill }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-4">
                ...
                <div>
                    <label for="company" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Damage
                        Skill</label>
                    <input type="text" id="damage_skill" name="damage_skill" value="{{ $skill->damage_skill }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Damage" required>
                </div>
                <div>
                    <label for="company" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Proc
                        Rate
                        Skill</label>
                    <input type="text" id="proc_rate_skill" name="proc_rate_skill"
                        value="{{ $skill->proc_rate_skill }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                    <label for="company" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Effect
                        Skill</label>
                    <input type="text" id="effect_skill" name="effect_skill" value="{{ $skill->effect_skill }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                    <label for="company" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Launch
                        Skill</label>
                    <input type="text" id="launch_skill" name="launch_skill" value="{{ $skill->launch_skill }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                    <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tier
                        Skil</label>
    ...
    <script>
        ...
        const gradeSelect = document.getElementById('grade_skill');
        const chakraSelect = document.getElementById('chakra_skill');
        const roundSelect = document.getElementById('round_skill');
        const kategoriSelect = document.getElementById('kartegori');
        const tierSelect = document.getElementById('tier_skill');

        var gradeSkill = '{{ $skill->grade_skill }}';
        var chakraSkill = '{{ $skill->chakra_skill }}';
        var roundSkill = '{{ $skill->round_skill }}';
        var tierSkill = '{{ $skill->tier_skill }}';
        var kategoriSkill = '{{ $skill->kartegori }}';

        gradeSelect.value = gradeSkill;
        chakraSelect.value = chakraSkill;
        roundSelect.value = roundSkill;
        tierSelect.value = tierSkill;
        kategoriSelect.value = kategoriSkill;
    </script>
