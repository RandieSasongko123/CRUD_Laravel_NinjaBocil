...
<body>
    <section class="min-h-screen flex items-center justify-center"
        ...
        ">
        <!-- login container -->
        <div class="hover:shadow-xl bg-[#6A6A6A] bg-opacity-30 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
            <!-- form -->
            <div class="md:w-1/2 px-8 md:px-16">
                <h2 class="font-bold text-2xl text-white">Login</h2>
                <p class="text-xs mt-4 text-white">If you are already a member, easily log in</p>
                <form class="flex flex-col gap-4" method="POST" action="/loginproses">
                    @csrf
                ...
                <div class="mt-3 text-xs flex justify-between items-center text-white">
                    ...
                    <button
                        class="py-2 px-5 bg-grey-100 border rounded-xl hover:scale-110 duration-300">Register</button>
                </div>
            </div>
            ...
            <div class="md:block hidden w-1/2">
                ...
                <img class="rounded-2xl" src="{{ asset('image/test3.jpg') }}" alt="" style="height: 550px;">
            </div>
        </div>
    </section>
</body>
